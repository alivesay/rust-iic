    ...
    pub fn ss_read(&mut self, addr: u16) -> u8 {
      ...
      let is_80store = self.is_80store.get();
        ...
        let result = match addr {
            ...
            0xC081 => { set_lcram_mode_rr!(self.mem_state, LcRamMode::C081, addr, self.last_read_addr) },
            0xC082 => { set_lcram_mode!(self.mem_state, LcRamMode::C082) },
            0xC083 => { set_lcram_mode_rr!(self.mem_state, LcRamMode::C083, addr, self.last_read_addr) },

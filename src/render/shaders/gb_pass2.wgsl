...
fn fs_main(in: VsOut) -> @location(0) vec4<f32> {
    ...
    // sigma=4.0, normalized 5-tap (one-sided) weights.
    ...
    col.a += textureSampleLevel(src_tex, src_samp, clamp(in.uv + vec2<f32>(texel.x, 0.0), lower, upper), 0.0).a * w1;
    col.a += textureSampleLevel(src_tex, src_samp, clamp(in.uv - vec2<f32>(texel.x, 0.0), lower, upper), 0.0).a * w1;
    col.a += textureSampleLevel(src_tex, src_samp, clamp(in.uv + vec2<f32>(2.0 * texel.x, 0.0), lower, upper), 0.0).a * w2;
    col.a += textureSampleLevel(src_tex, src_samp, clamp(in.uv - vec2<f32>(2.0 * texel.x, 0.0), lower, upper), 0.0).a * w2;
    col.a += textureSampleLevel(src_tex, src_samp, clamp(in.uv + vec2<f32>(3.0 * texel.x, 0.0), lower, upper), 0.0).a * w3;
    col.a += textureSampleLevel(src_tex, src_samp, clamp(in.uv - vec2<f32>(3.0 * texel.x, 0.0), lower, upper), 0.0).a * w3;
    col.a += textureSampleLevel(src_tex, src_samp, clamp(in.uv + vec2<f32>(4.0 * texel.x, 0.0), lower, upper), 0.0).a * w4;
    col.a += textureSampleLevel(src_tex, src_samp, clamp(in.uv - vec2<f32>(4.0 * texel.x, 0.0), lower, upper), 0.0).a * w4;
